...
class FieldLineConnector(FieldLineCallback):
    ...
    def callback_chassis_connected(self, chassis_name, chassis_id):
        ...
        print("CONNECTOR Chassis %s with ID %d connected" % (chassis_name, chassis_id))
        sys.stdout.flush()

    # required callback
    def callback_chassis_disconnected(self, chassis_id):
        print("CONNECTOR Chassis %s disconnected" % self.chassis_id_to_name[chassis_id])
        sys.stdout.flush()
        del self.chassis_id_to_name[chassis_id]

    # required callback
    def callback_sensors_available(self, chassis_id, sensor_list):
        print("CONNECTOR Chassis %s has sensors %s" % (self.chassis_id_to_name[chassis_id], sensor_list))
        sys.stdout.flush()
    ...
    def callback_sensor_ready(self, chassis_id, sensor_id):
        print("CONNECTOR Chassis %s sensor %d ready" % (self.chassis_id_to_name[chassis_id], sensor_id))
        sys.stdout.flush()
    ...
    def callback_restart_begin(self, chassis_id, sensor_id):
        print("CONNECTOR Chassis %s sensor %d restart" % (self.chassis_id_to_name[chassis_id], sensor_id))
        sys.stdout.flush()

    # required callback
    def callback_restart_complete(self, chassis_id, sensor_id):
        print("CONNECTOR Chassis %s sensor %d restart complete" % (self.chassis_id_to_name[chassis_id], sensor_id))
        sys.stdout.flush()
    ...
    def callback_coarse_zero_begin(self, chassis_id, sensor_id):
        print("CONNECTOR Chassis %s sensor %d coarse zero" % (self.chassis_id_to_name[chassis_id], sensor_id))
        sys.stdout.flush()

    # required callback
    def callback_coarse_zero_complete(self, chassis_id, sensor_id):
        print("CONNECTOR Chassis %s sensor %d coarse zero complete" % (self.chassis_id_to_name[chassis_id], sensor_id))
        sys.stdout.flush()
    ...
    def callback_fine_zero_begin(self, chassis_id, sensor_id):
        print("CONNECTOR Chassis %s sensor %d fine zero" % (self.chassis_id_to_name[chassis_id], sensor_id))
        sys.stdout.flush()

    # required_callback
    def callback_fine_zero_complete(self, chassis_id, sensor_id):
        print("CONNECTOR Chassis %s sensor %d fine zero complete" % (self.chassis_id_to_name[chassis_id], sensor_id))
        sys.stdout.flush()
    ...
    def callback_sensor_error(self, chassis_id, sensor, msg):
        print("CONNECTOR Chassis %s sensor %d returned error: %s" % (self.chassis_id_to_name[chassis_id], sensor, msg))
