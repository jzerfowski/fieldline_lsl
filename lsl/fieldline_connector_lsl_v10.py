...
class FieldLineConnector(FieldLineCallback):
    ...
    def callback_sensor_error(self, chassis_id, sensor, msg):
        logger.info(f"CONNECTOR Chassis {self.chassis_id_to_name[chassis_id]} sensor {sensor} returned error: {msg}")
    ...
    def set_sensor_valid(self, chassis_id, sensor):
        self.valid_sensors_list.append((chassis_id, sensor))
